...
class Config(BaseModel):
    ...
    organization: list[Entity] = Field(alias="ORGANIZATION", default_factory=list)
    ...
    # Assigned one per input document rather than detected in body text. See
    # did.core.entity_types.DOCUMENT_TITLE.
    document_title: list[Entity] = Field(alias="DOCUMENT_TITLE", default_factory=list)
